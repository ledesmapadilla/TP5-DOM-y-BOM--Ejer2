class Persona {
  ...
  /* metodos ejercicio2 mostrar generacion*/
  mostrarGeneracion() {
    const generacion = /* this.#anioNacimiento */ 1968;
    ...
    if (generacion >= 1930 && generacion <= 1948) {
      ...
      nuevaGeneracion = `Generacion X`;
    } else if (generacion >= 1981 && generacion <= 1993) {
      nuevaGeneracion = `Generacion y`;
    } else {
      nuevaGeneracion = `Generacion Z`;
    }

    /* alert(nuevaGeneracion); */
